...
import { actions, cardList } from '../../../mock';
...
const ActionModal = (props: Props) => {
    const { state, index, cardData, onClose, deleteFoodStyle, duplicateFoodStyle, shareFoodStyle } = props;
                ...
                <View style={styles.contentModal}>
                    <View style={[styles.itemList, {
                        ...
                        <Pressable style={styles.btnOption} onPress={onClose}>
                            <Image
                                source={IC_CLOSE}
                                style={styles.icOption}
                            />
                        </Pressable>
                    </View>
                    <View style={[styles.lstAction, state.bottom > HEIGHT_ACTION ? {
                        ...
                        {
                            arrAction?.map((item: { name: string; icon: ImageSourcePropType; }, idx: number) => <ActionComponent
                                item={item}
                                idx={idx}
